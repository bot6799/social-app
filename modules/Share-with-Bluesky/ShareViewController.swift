...
class ShareViewController: UIViewController {
  ...
  // scheme.
  let appScheme = Bundle.main.object(forInfoDictionaryKey: "MainAppScheme") as? String ?? "eurso"
  ...
  private func getTempUrl(ext: String) -> URL? {
    if let dir = FileManager().containerURL(forSecurityApplicationGroupIdentifier: "group.so.eur.app") {
