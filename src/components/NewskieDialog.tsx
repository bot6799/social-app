  ...
  const getJoinMessage = () => {
    ...
    if (isMe) {
      if (profile.joinedViaStarterPack) {
        return _(
          msg`You joined Europe Social using a starter pack ${timeAgoString} ago`,
        )
      } else {
        return _(msg`You joined Europe Social ${timeAgoString} ago`)
      }
    } else {
      if (profile.joinedViaStarterPack) {
        return _(
          msg`${profileName} joined Europe Social using a starter pack ${timeAgoString} ago`,
        )
      } else {
        return _(msg`${profileName} joined Europe Social ${timeAgoString} ago`)
      }
    }
  }
