            ...
            <Admonition.Outer type="tip" style={[a.flex_1]}>
              <Admonition.Row>
                ...
                <Admonition.Content>
                  <Admonition.Text>
                    <Trans>
                      Note: Europe Social is part of the AT Protocol, an open
                      and public network. This setting only limits the
                      visibility of your content on Europe Social, and other
                      apps may not respect this setting. Your content may still
                      be shown to logged-out users by other apps and websites.
                    </Trans>
                  </Admonition.Text>
                  <Admonition.Text>
                    <InlineLinkText
                      label={_(
                        msg`Learn more about privacy on Europe Social.`,
                      )}
                      to="https://europesocial.org/privacy">
                      <Trans>Learn more about privacy on Europe Social.</Trans>
                    </InlineLinkText>
                  </Admonition.Text>
                </Admonition.Content>
              </Admonition.Row>
