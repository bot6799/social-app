...
export const GEOLOCATION_PROD_URL = `https://api.eur.so`
...
export const LIVE_EVENTS_PROD_URL = `https://api.eur.so/events`
...
export const APP_CONFIG_PROD_URL = `https://api.eur.so`
